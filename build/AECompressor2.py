...
class AECompressor2:
  ...
  def compress(self, data,state_bits):
    encoder = AE.Encoder(state_bits)
  ...
  def decompress(self, encoded, length_encoded,state_bits):
    decoded = []
    model = self.__model
    decoder = AE.Decoder(encoded,state_bits)
