                                                ...
                                                if match:
                                                      ...
                                                      for band_number,band in enumerate(ALL_BANDS):
                                                            ...
                                                            with outputPath.open('wb') as outputFile,rasterio.io.MemoryFile() as memfile:
                                                                  ...
                                                                  with memfile.open(outputFile,mode='w',width=imax+120,height=jmax+120,count=1,dtype="uint16",crs=data["meta"][ALL_BANDS[band_number]]["crs"],transform=data["meta"][ALL_BANDS[band_number]]["transform"]) as file2:
